...
begin
  ...
  values (
    ...
    v_eta,
    case
      when v_rider.distance_km is null then 'Store marked ready; assigned online rider'
      else 'Store marked ready; assigned nearest online rider (' || round(v_rider.distance_km, 2) || ' km away)'
    end
  );
